...
##### modified by xiaolaba, for Mega2560 bootloader and build
...
#PROJECTNAME=samsung_lcd
PROJECTNAME=stk500boot_v3_mega2560
...
#
## usbtiny is USB programmer, no need this AVRDUDE_PORT specific
